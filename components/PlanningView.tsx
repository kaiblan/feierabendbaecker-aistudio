      ...
      <div className="flex-1 px-4 lg:px-8 py-8 space-y-8 animate-fade-in">
        <header className="max-w-7xl mx-auto w-full flex justify-between items-end">
            ...
            <div className="text-right">
              <span className="text-[11px] mono text-slate-400 block uppercase tracking-widest">{t('totalDuration')}</span>
          ...
          {!isRecipeStage ? (
            <>
              ...
              <section className="order-2 lg:order-1 lg:col-span-4 w-full bg-slate-950/60 border border-slate-800 rounded-2xl p-6 space-y-6">
                <h3 className="text-[11px] font-bold text-cyan-500 mono uppercase tracking-widest border-b border-slate-800 pb-3">{t('basicFactors')}</h3>
                ...
                <div className="space-y-3">
                   ...
                   <div className="pt-3 border-t border-slate-700/50">
                      ...
                      <div className="space-y-4 mt-4">
                        <div className="flex justify-between items-end">
                          <label className="text-[11px] text-slate-400 mono uppercase">{t('fridgeTemperature')}</label>
